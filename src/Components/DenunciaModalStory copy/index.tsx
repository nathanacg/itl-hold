...
import { reportDrops } from '../../Service/Drop'
...
export default function DenunciaModalDrops(props: DenunciaModalProps) {
    ...
    const reportCartaz = async (postHexId: string, reason: string) => {
        await reportDrops(postHexId, reason).then((res) => {
            console.log('Drops reportado.', res.data)
        }).catch((error) => {
                    ...
                    <View style={{ gap: 15, marginBottom: 10 }}>
                        {props.spoilerOption && (
                            <OptionContent onPress={() => {
                                reportCartaz(props.postHexId, "1")
                        ...
                        <OptionContent
                            onPress={
                                () => {
                                    reportCartaz(props.postHexId, "2")
                        ...
                        <OptionContent
                            onPress={
                                () => {
                                    reportCartaz(props.postHexId, "3")
                        ...
                        <OptionContent
                            onPress={
                                () => {
                                    reportCartaz(props.postHexId, "4")
                        ...
                        <OptionContent
                            onPress={
                                () => {
                                    reportCartaz(props.postHexId, "5")
                        ...
                        <OptionContent
                            onPress={
                                () => {
                                    reportCartaz(props.postHexId, "6")
                        ...
                        <OptionContent
                            onPress={
                                () => {
                                    reportCartaz(props.postHexId, "7")
                        ...
                        <OptionContent
                            onPress={
                                () => {
                                    reportCartaz(props.postHexId, "8")
                        ...
                        <OptionContent
                            onPress={
                                () => {
                                    reportCartaz(props.postHexId, "9")
                        ...
                        <OptionContent
                            onPress={
                                () => {
                                    reportCartaz(props.postHexId, "10")
