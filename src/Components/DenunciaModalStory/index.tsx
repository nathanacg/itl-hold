...
import { reportStory } from '../../Service/Story'
...
export default function DenunciaModalStory(props: DenunciaModalProps) {
    ...
    const reportStorie = async (postHexId: string, reason: string) => {
        await reportStory(postHexId, reason)
            .then((res) => {
                console.log('Cartaz reportado.')
            }).catch((error) => {
                    ...
                    <View style={{ gap: 15, marginBottom: 10 }}>
                        {props.spoilerOption && (
                            <OptionContent onPress={() => {
                                reportStorie(props.postHexId, "1")
                        ...
                        <OptionContent
                            onPress={
                                () => {
                                    reportStorie(props.postHexId, "2")
                        ...
                        <OptionContent
                            onPress={
                                () => {
                                    reportStorie(props.postHexId, "3")
                        ...
                        <OptionContent
                            onPress={
                                () => {
                                    reportStorie(props.postHexId, "4")
                        ...
                        <OptionContent
                            onPress={
                                () => {
                                    reportStorie(props.postHexId, "5")
                        ...
                        <OptionContent
                            onPress={
                                () => {
                                    reportStorie(props.postHexId, "6")
                        ...
                        <OptionContent
                            onPress={
                                () => {
                                    reportStorie(props.postHexId, "7")
                        ...
                        <OptionContent
                            onPress={
                                () => {
                                    reportStorie(props.postHexId, "8")
                        ...
                        <OptionContent
                            onPress={
                                () => {
                                    reportStorie(props.postHexId, "9")
                        ...
                        <OptionContent
                            onPress={
                                () => {
                                    reportStorie(props.postHexId, "10")
