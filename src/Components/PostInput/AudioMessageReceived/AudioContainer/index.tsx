  ...
  return (
    <>
      <Container>
        ...
        <SoundBar metricsTime={props.configAudMetrics} countBar={props.repost && 61 || props.feed && 71 || props.publication && 60 || props.preview && 68} position={timeLimit} play={isPlaying} />
      </Container>
