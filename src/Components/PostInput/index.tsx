...
import { InputCount, InputLegend } from './style';
  ...
  const formatarTempo = (segundos: number) => {
    ...
    const formatoSegundos =
      segundosRestantes < 10
        ? `0${segundosRestantes.toFixed(0)}`
        : segundosRestantes.toFixed(0);
          ...
          {!isRecording && audioPath && (
            <View
              ...
              <AudioMessageReceived
                ...
                configAudMetrics={[
                  -33.92938995361328, -35.6361083984375, -22.325828552246094,
                  -20.04671287536621, -26.937410354614258, -37.697021484375,
                  -39.822540283203125, -38.041709899902344, -41.189544677734375,
                  -35.6361083984375, -22.325828552246094, -38.041709899902344,
                  -41.189544677734375, -35.6361083984375, -38.041709899902344,
                  -41.189544677734375, -35.6361083984375, -22.325828552246094,
                  -22.325828552246094, -20.04671287536621, -26.937410354614258,
                  -37.697021484375, -39.822540283203125, -42.133541107177734,
                  -42.133541107177734, -32.26824188232422, -32.26824188232422,
                  -13.833025932312012, -13.833025932312012, -24.762142181396484,
                  -38.041709899902344, -41.189544677734375, -35.6361083984375,
                  -22.325828552246094, -24.762142181396484, -23.383811950683594,
                  ...
                  -35.6361083984375, -22.325828552246094, -20.04671287536621,
                  -26.937410354614258, -37.697021484375, -39.822540283203125,
                  -20.133541107177734, -42.133541107177734, -32.26824188232422,
                  ...
                  -20.04671287536621, -26.937410354614258, -20.697021484375,
                  -22.325828552246094, -20.04671287536621, -26.937410354614258,
        ...
        <TouchableOpacity
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            {isRecording && showCronometro && (
              <Text style={{ color: 'gray', marginLeft: 2, fontSize: 20 }}>
