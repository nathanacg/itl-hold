...
import {
  ...
  ContentModalButtons,
  TextButton,
} from '../../../../Components/Modal/Components/style';
...
//   const { setNickName } = useCreatePost();
  ...
  const handleNavigateToProfile = async () => {
    try {
      ...
      // setNickName(Object.values(response.data.post)[0].userNickname)
      setIsModalOpen(!isModalOpen);
      navigation.push('TabNavigation', {
        screen: 'OtherProfileScreen',
        params: { nickName: Object.values(response.data.post)[0].userNickname },
      });
    } catch (error) {
