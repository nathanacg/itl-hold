...
interface MusicsmallProps {
    selectedMusic: { uri: string, musicName: string, artist: string, left: number, top: number, styleType: string, scale: number }
    setSelectedMusic: React.Dispatch<SetStateAction<{
        uri: string;
        musicName: string;
        artist: string;
        left: number;
