...
export default function PostScreenSearch() {
    const routes = useRoute()
    const params = routes.params as { isArquivaded?: boolean }
            ...
            <Container showsVerticalScrollIndicator={false}>
                ...
                <ContainerView>
                    ...
                    <Post
                        ...
                        //showLikes={post.accountConfig.showLikes}
